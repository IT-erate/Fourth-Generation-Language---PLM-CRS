...
function generateTable($x,$y,&$arr,&$sub)
{
	...
	echo "<div class='table table-responsive'>
										<table class='table table-hover' id='wow'>
											<thead>
												<tr>
													<th>Subject</th>
													<th>Passed</th>
...
<html lang="en">
	...
	<body onload="generateChart();">
		<div class="jumbotron"> 
			<center>
			<h1><strong>PASSED AND FAILED STUDENTS PER SUBJECT</strong></h1>
			</center>
		</div>
						...
						<div id="myCarousel1" class="carousel slide" data-ride="carousel" data-interval="false" >
							...
							<div class="carousel-inner" role="listbox">
								<div class="item active">
								 ...
								 <br><br>
								 <center><?php generateTable(0,0,$arr_students,$arr_subjects); ?></center> 
									 <hr>
								...
								<div class="item">
									...
									<br><br>
								 	<center><?php generateTable(0,1,$arr_students,$arr_subjects); ?></center> 
				...
				<div id="myCarousel2" class="carousel slide" data-ride="carousel" data-interval="false" >
							...
							<div class="carousel-inner" role="listbox">
								<div class="item active" >
									...
									<br><br>
								 	<center><?php generateTable(1,0,$arr_students,$arr_subjects); ?></center> 
								...
								<div class="item">
									...
									<br><br>
								 	<center><?php generateTable(1,1,$arr_students,$arr_subjects); ?></center>
				...
				<div id="myCarousel3" class="carousel slide" data-ride="carousel" data-interval="false" >
							...
							<div class="carousel-inner" role="listbox">
								<div class="item active" >
									...
									<br><br>
								 	<center><?php generateTable(2,0,$arr_students,$arr_subjects); ?></center> 

									<canvas id="myChart5" class="chart"></canvas>
									<br>
									<center><button type="button" onclick="downloadPDF(8);">Export to PDF</button></center>
								</div>   

								<div class="item">
									<div class="container"><center>Third Year, Second Semester</center> </div>
									<br><br>
								 	<center><?php generateTable(2,1,$arr_students,$arr_subjects); ?></center>
									<canvas id="myChart6" class="chart"></canvas>

									<br> 
										<center><button type="button" onclick="downloadPDF(9);">Export to PDF</button></center>
								</div>
							</div>
				...
				<div id="myCarousel4" class="carousel slide" data-ride="carousel" data-interval="false" >
							...
							<div class="carousel-inner" role="listbox">
								<div class="item active" > 
									...
									<br><br>
								 	<center><?php generateTable(3,0,$arr_students,$arr_subjects); ?></center> 

									<canvas id="myChart7" class="chart"></canvas>
									<br>
									<center><button type="button" onclick="downloadPDF(12);">Export to PDF</button></center>
								</div>  

								<div class="item">
									<div class="container"><center>Fourth Year, Second Semester</center> </div>
									<br><br>
								 	<center><?php generateTable(3,1,$arr_students,$arr_subjects); ?></center>

									<canvas id="myChart8" class="chart"></canvas>
										<br> 
										<center><button type="button" onclick="downloadPDF(13);">Export to PDF</button></center>
								</div>
							</div>
